...
class ProceduresFabricator {
    ...
    companion object {
        private const val FIXED_DATE_STRING = "2024-03-15T10:30:00.000000Z"
        private val FIXED_DATE = ZonedDateTime.parse(FIXED_DATE_STRING)
        ...
        fun createProcedureWithFavorite(
            procedure: ProcedureEntity = createProcedureEntity(),
        ...
        fun createProcedureItem(
            ...
            duration: Int = 90,
            isFavorite: Boolean = true
        ) = ProcedureItem(id, name, iconUrl, duration, isFavorite)
        ...
        fun createProcedureDetail(
            ...
            cardUrl: String = "https://example.com/cards/health-checkup.png",
            phasesCount: Int = 4,
            datePublished: ZonedDateTime = FIXED_DATE,
        ...
        fun createIconApiModel(
            url: String = "https://example.com/icons/default.png"
        ) = IconApiModel(url)

        fun createCardApiModel(
            url: String = "https://example.com/cards/default.png"
        ) = CardApiModel(url)
    }
}
